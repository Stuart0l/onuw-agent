...
def _guide_locked(dealt_role: Role) -> str:
    return (
        ...
        "this speech. Commit on first pick; do NOT reconsider "
        "alternatives.\n"
        "\n"
...
def _guide_committed(committed_role: Role) -> str:
    return (
        ...
        "and your prior PER-PLAYER HYPOTHESIS is shown above. They "
        "are your STARTING POINT for this turn — do NOT re-derive "
        "from scratch.\n"
        "\n"
        "  STEP 2 — UPDATE HYPOTHESIS: walk through any NEW speeches "
        "since your last turn. For each affected player, revise their "
        "hypothesis entry (role / confidence / evidence) only if a "
        "new speech credibly changes your view. Leave unaffected "
        "entries unchanged.\n"
        "\n"
        "  STEP 3 — REVIEW COMMITTED ROLE: reading STEP 2's updated "
        "entries — does any credibly imply your card was swapped "
        "(Robber claims to have swapped you, Troublemaker claims to "
        "have swapped your card)? If no, KEEP. If yes, name the "
        "change in ONE LINE and update.\n"
        "\n"
...
THINKING_GUIDE_VOTE = (
    ...
    "\n"
    "  STEP 1 — RECALL: your current role and team (committed during "
    "the day phase) AND your PER-PLAYER HYPOTHESIS section above. "
    "Those entries are your settled view of who is who — do NOT "
    "re-derive the game state from the discussion log, do NOT count "
    "the deck, do NOT branch into scenarios.\n"
    "\n"
    "  STEP 2 — UPDATE (only if needed): in ONE LINE, has anything in "
    "the LATEST round of speeches changed your view? If no, write "
    "\"no change\" and move on.\n"
    "\n"
    "  STEP 3 — PICK: the highest-EV vote target for your team, based "
    "on your PER-PLAYER HYPOTHESIS. Final.\n"
    "\n"
    "  STEP 4 — WRITE: the JSON below."
)