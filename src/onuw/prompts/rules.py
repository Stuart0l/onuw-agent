...
THINKING_GUIDE_VOTE = (
    ...
    "the day phase) AND your PRIVATE BELIEFS section above. Those "
    "beliefs are your settled view of who is who — do NOT re-derive "
    "the game state from the discussion log, do NOT count the deck, "
    "do NOT branch into scenarios.\n"
    "\n"
